...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `snippets_AFTER_INSERT` AFTER INSERT ON `snippets` FOR EACH ROW BEGIN
INSERT INTO modification_log (wfo_id, modified) VALUES (NEW.wfo_id, now())
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `snippets_AFTER_UPDATE` AFTER UPDATE ON `snippets` FOR EACH ROW BEGIN
INSERT INTO modification_log (wfo_id, modified) VALUES (NEW.wfo_id, now())
  ON DUPLICATE KEY UPDATE modified = now();
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `snippets_BEFORE_DELETE` BEFORE DELETE ON `snippets` FOR EACH ROW BEGIN
INSERT INTO modification_log (wfo_id, modified) VALUES (OLD.wfo_id, now())
  ON DUPLICATE KEY UPDATE modified = now();
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `wfo_scores_AFTER_INSERT` AFTER INSERT ON `wfo_scores` FOR EACH ROW BEGIN
INSERT INTO modification_log (wfo_id, modified) VALUES (NEW.wfo_id, now())
  ON DUPLICATE KEY UPDATE modified = now();
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `wfo_scores_AFTER_UPDATE` AFTER UPDATE ON `wfo_scores` FOR EACH ROW BEGIN
INSERT INTO modification_log (wfo_id, modified) VALUES (NEW.wfo_id, now())
  ON DUPLICATE KEY UPDATE modified = now();
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `wfo_scores_BEFORE_DELETE` BEFORE DELETE ON `wfo_scores` FOR EACH ROW BEGIN
INSERT INTO modification_log (wfo_id, modified) VALUES (OLD.wfo_id, now())
  ON DUPLICATE KEY UPDATE modified = now();
END */;;
DELIMITER ;
...
-- Dump completed on 2026-03-30 16:35:28
